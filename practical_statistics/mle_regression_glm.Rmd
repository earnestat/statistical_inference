...
**Computational Note**: Because the likelihood is usually very large, instead of maximizing the likelihood, we usually minimize the negative log-likelihood $-\mathcal{LL}$ (more on this below).

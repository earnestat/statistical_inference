...
*Box-plots* are a great way to visualize where most of the data lies, along with *outliers* and *summary statistics* such as *median*. In a box-plot, the top and bottom boundaries of the box are the *3rd* and *1st quartiles* of the data, respectively, the line in the middle the *median* and the circular data points the *outliers* (all of these to be defined precisely below).We now plot the microtubule lifetime data as a set of box-plots with [Tb] on the x-axis.
...
- Bee swarm plots are a great way to visualize all of your data if there is too much of it for a scatter plot;
...
```
see about bagplots (bivariate box-plots) here: https://en.wikipedia.org/wiki/Bagplot.

...
**Exercise**
Previously, we generated some data that we claimed to be *Gaussian* in order to demonstrate the Central Limit Theorem. The code is below. The exercise is to
...
boxplot(age~type,data=data)        #graphical summary
```

##Example 3: ANOVA for bioinoformatics

We will consider an example from (Pavladis, 2003):
...
#The following code is from the Supplementary material to
#Using ANOVA for gene selection from microarray studies of the nervous system (Pavladis, 2003)
